      ...
      <div className="bg-gradient-to-b from-purple-900/50 to-slate-900 py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-extrabold mb-3 text-orange-400">
            StreameX Your Ultimate Movie & TV Database
        ...
        <div className="bg-gray-800/50 p-8 rounded-xl shadow-lg backdrop-blur-sm">
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              <img
                src="https://live.staticflickr.com/65535/55082911958_709cdb67ef_b.jpg"
          ...
          <section className="mb-16 bg-gray-900/50 p-8 rounded-xl">
            <h2 className="text-3xl font-bold mb-8 text-center text-orange-300">
              About Streamex: Your Ultimate Streaming Companion
            ...
            <div className="space-y-6 text-gray-400 text-justify">
              ...
              <p>
                Streamex excels at helping users explore content by genre. Our specialized sections include:
              </p>
              ...
              <p>
                We help users find both <strong>free movie streaming</strong> options (ad-supported platforms) and premium subscription content. Our database includes information about free trials, bundle deals, and cost-effective ways to access multiple streaming services. Whether you want to watch free content or maximize your premium subscriptions, Streamex provides the information you need to make smart viewing choices.
              </p>
              ...
              <h3 className="text-2xl font-semibold text-blue-300 mb-4">Why Choose Streamex?</h3>
              
              <p>
                Streamex stands out as the most user-friendly and comprehensive movie database because:
              </p>
              <ul className="ml-6 space-y-2">
              ...
              <p>
                Join millions of users who trust Streamex to help them decide what to watch next. Whether you're searching for "watch movie online free", "stream movies HD", "best Netflix series", "Disney+ new releases", "Prime Video movies", or specific genre content like "action movies 2024" or "horror series to watch", Streamex delivers accurate, up-to-date information to enhance your viewing experience. Our platform continuously updates with new releases, streaming changes, and trending content to ensure you never miss out on great entertainment.
              </p>
            </div>
          </section>
          ...
          <section className="text-center py-12 bg-gradient-to-r from-orange-900/30 to-purple-900/30 rounded-xl">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Join millions who use Streamex to watch movies, stream series, and discover new favorites across Netflix, Disney+, Prime Video, and more. Get HD quality recommendations, box office updates, and personalized suggestions.
            </p>
